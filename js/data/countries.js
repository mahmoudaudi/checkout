/**
 * @module countries
 * @description Complete world countries list with ISO codes, dial codes, and flag emojis.
 * Used by PersonalInformation (dial-code selector) and AddressInformation (country selector).
 *
